...
public class GPSCompound_list extends AppCompatActivity {
    ...
    Connection C;
    Global g;
    private List<GPSCompound_DataModel> dataList = new ArrayList<>();
 ...
 public void onCreate(Bundle savedInstanceState) {
   ...
   try
     {
         setContentView(R.layout.gpscompound_list);
     ...
     {
         Connection.MessageBox(GPSCompound_list.this, e.getMessage());
         return;
     }
 }
 ...
 private void DataSearch(String SearchText)
       ...
       try
        {
           ...
           GPSCompound_DataModel d = new GPSCompound_DataModel();
             String SQL = "Select * from "+ TableName +"  Where VillID like('"+ SearchText +"%') or CompoundID like('"+ SearchText +"%') and isdelete=2";
             ...
             try {
                 ...
                 Connection.MessageBox(GPSCompound_list.this,ex.getMessage());
             }
        }
        catch(Exception  e)
        {
     ...
     public class DataAdapter extends RecyclerView.Adapter<DataAdapter.MyViewHolder> {
         private List<GPSCompound_DataModel> dataList;
         ...
         public DataAdapter(List<GPSCompound_DataModel> datalist) {
             this.dataList = datalist;
         }
         @Override
         public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
             View itemView = LayoutInflater.from(parent.getContext())
                     .inflate(R.layout.gpscompound_row, parent, false);
             return new MyViewHolder(itemView);
         }
         @Override
         public void onBindViewHolder(MyViewHolder holder, int position) {
             final GPSCompound_DataModel data = dataList.get(position);
             ...
             holder.secListRow.setOnClickListener(new View.OnClickListener() {
                 public void onClick(View v) {
                     final ProgressDialog progDailog = ProgressDialog.show(GPSCompound_list.this, "", "Please Wait . . .", true);
                     new Thread() {
                         public void run() {
                             try {
                                 Bundle IDbundle = new Bundle();
                                 ...
                                 Intent f1 = new Intent(getApplicationContext(), GPSCompound.class);
