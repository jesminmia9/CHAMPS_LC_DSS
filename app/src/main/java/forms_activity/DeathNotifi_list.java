...
public class DeathNotifi_list extends AppCompatActivity {
 ...
 public void onCreate(Bundle savedInstanceState) {
   ...
   try
     {
         setContentView(R.layout.deathnotifi_list);
             ...
             public void onClick(View view) {
                 ...
                 if (!Global.isNullOrEmpty(total_death_entry)) {
                     if (Integer.parseInt(total_death_in_household)<= Integer.parseInt(total_death_entry)) {
                         Connection.MessageBox(DeathNotifi_list.this, "You can't enter more death information where as total number of death is " + total_death_in_household + " in household. \n\nPlease update data in household visit form before entering more deaths.");
                     } else {
                         ...
                         Intent intent = new Intent(getApplicationContext(), DeathNotifi.class);
     ...
     {
         Connection.MessageBox(DeathNotifi_list.this, e.getMessage());
         return;
     }
 }
       ...
       try
        {
           ...
           DeathNotifi_DataModel d = new DeathNotifi_DataModel();
             ...
             try {
                 ...
                 Connection.MessageBox(DeathNotifi_list.this,ex.getMessage());
             }
        }
        catch(Exception  e)
        {
     ...
     public class DataAdapter extends RecyclerView.Adapter<DataAdapter.MyViewHolder> {
         ...
         public void onBindViewHolder(MyViewHolder holder, int position) {
             ...
             holder.secListRow.setOnClickListener(new View.OnClickListener() {
                 public void onClick(View v) {
                     final ProgressDialog progDailog = ProgressDialog.show(DeathNotifi_list.this, "", "Please Wait . . .", true);
                     new Thread() {
                         public void run() {
                             try {
                                 Bundle IDbundle = new Bundle();
