...
import barcodeSourceRavi8x.camera.CameraSource;
import barcodeSourceRavi8x.camera.CameraSourcePreview;
import barcodeSourceRavi8x.camera.GraphicOverlay;
...
public class BarcodeReader extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    private boolean useSceneModeBarcode = false;
    ...
    private static int maxWidth=5000;
    private static int maxHeight=5000;
    ...
    public void setAutoFlash(boolean autoFlash) {
        this.useFlash= autoFlash;

    }

    public void setSceneModeBarcode(boolean sceneModeBarcode) {
        this.useSceneModeBarcode= sceneModeBarcode;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_barcode_reader,
                container,
                false);
    ...
    public void onInflate(Context context, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        autoFocus = a.getBoolean(R.styleable.BarcodeReader_auto_focus, false);
    ...
    private void proceedAfterPermission() {
        createCameraSource(autoFocus, useFlash,useSceneModeBarcode);
    }
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash,boolean useSceneModeBarcode) {
        ...
        if(useSceneModeBarcode)
        {
            builder.setSceneMode(Camera.Parameters.SCENE_MODE_BARCODE );
        }
        ...
        if(useFlash)
        {
            builder= builder.setFlashMode( Camera.Parameters.FLASH_MODE_AUTO );
        }
...
/*
       ...
       /* try {
            ...
            MediaPlayer ring= MediaPlayer.create(BarcodeReader.this,R.raw.beep);
            ring.start();
    ...
    private boolean setMaxWidthHeight()
    {
