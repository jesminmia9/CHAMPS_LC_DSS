...
//    }
    ...
    private void PopulateTab()
    {
            ...
            public void onTabChanged(final String tabId) {
                ...
                try {
                    if(tabId.equals("ecd_status")){
                        ...
                        org.icddrb.champs_lc_dss.data_from_content activity = (org.icddrb.champs_lc_dss.data_from_content) getLocalActivityManager().getActivity(tabId);
        ...
        while(!cur.isAfterLast())
        {
            ...
            Intent intbirthObj = new Intent(this, org.icddrb.champs_lc_dss.data_from_content.class);
