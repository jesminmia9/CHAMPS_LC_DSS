...
public class Fragment_Main extends AppCompatActivity
    ...
    public boolean onKeyDown(int iKeyCode, KeyEvent event) {
        if (iKeyCode == KeyEvent.KEYCODE_BACK || iKeyCode == KeyEvent.KEYCODE_HOME) {
            AlertDialog.Builder adb = new AlertDialog.Builder(Fragment_Main.this);
            adb.setTitle("Close");
    ...
    private void Activity_Load()
    {
        ...
        */
        ...
        if(ProjectSetting.LISTING_OR_BASELINE_OR_SURVEILLANCE.equals(ProjectSetting.LISTING)){
            selectedFragment =  Fragment_Home_Listing.newInstance();
        }else if(ProjectSetting.LISTING_OR_BASELINE_OR_SURVEILLANCE.equals(ProjectSetting.BASELINE)){
            selectedFragment =  Fragment_Home_Baseline.newInstance();
        }else{
            selectedFragment =  Fragment_Home_Surveillance.newInstance();
        }
