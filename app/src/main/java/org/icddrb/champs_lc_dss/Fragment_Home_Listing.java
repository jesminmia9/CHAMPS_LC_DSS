...
public class Fragment_Home_Listing extends Fragment {
    public static Fragment_Home_Listing newInstance() {
        Fragment_Home_Listing fragment = new Fragment_Home_Listing();
        return fragment;
    }
                ...
                new Thread() {
                    public void run() {
                        try {
                            ...
                            //----------------------------------------------------------------------
                            C.Sync_Download("DataCollector_AssignArea","DataCollector_AssignArea", "UserId='"+ ENTRYUSER +"'  and WorkGroup='1' and Active='1'");
                            String AREA_LIST = C.GetCatchmentArea(ENTRYUSER,"1");

                            //Upload data to server
                            //----------------------------------------------------------------------
                            List<String> tableList_upload = ProjectSetting.Listing_Upload();
                            ...
                            try {
                                C.Sync_Download("Compound", "Compound", "EntryUser='"+ ENTRYUSER +"' and VillID in("+ AREA_LIST +")");
                                count +=progressCount;
                            ...
                            try {
                                C.Sync_Download("GPS", "GPS", "EntryUser='"+ ENTRYUSER +"' and VillID in("+ AREA_LIST +")");
                                count +=progressCount;
                            ...
                            try {
                                C.Sync_Download("Household", "Household", "EntryUser='"+ ENTRYUSER +"' and VillID in("+ AREA_LIST +")");
                                count +=progressCount;
